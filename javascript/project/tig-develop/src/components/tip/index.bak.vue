<template>
  <div class="custom-tips">
    <el-popover
      ...
      <span @mouseover.once="updateData" :style="{opacity: opacity ? 1 : 0}" class="tipEle" slot="reference"><img src="../../../static/charts/images/tips.svg" alt="提示标记"></span>
    </el-popover>
  </div>
</template>
