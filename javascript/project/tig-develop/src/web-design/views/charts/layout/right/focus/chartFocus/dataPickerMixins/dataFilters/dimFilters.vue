...
<script>
  ...
  import dimFilterItem from './dimFilterItem'

  export default {
    name: 'DimFilters', // 数据关系里的过滤器
    props: {
      index: {} // 容器index
    },
    components: {dimFilterItem},
    data () {
      return {}
    },
    computed: {
    ...
    methods: {
      dimFoldHandle (e) {
        const selectSuffix = document.querySelector('.dim-filters .el-icon-arrow-up')
