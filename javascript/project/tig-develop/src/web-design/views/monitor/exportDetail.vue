<template>
  <div>
    ...
    <tablePaging ref="dataTable" :ajax="getTableData" :type="2" :columns="repExportHeaderList"></tablePaging>
  </div>
</template>
...
export default {
  data() {
    return {
      getTableData: apiMonitor.getExportDetailTableData,
      startDate: '',
      endDate: ''
    }
  },
